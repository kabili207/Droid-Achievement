...
public class AchievementActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		btnLoadFile.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				Intent i = new Intent(AchievementActivity.this, MainListView.class);
		...
		btnTest.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Fortune.DisplayFortune(AchievementActivity.this, offX, offY, spinOffset.getSelectedItem().toString());
		...
		ArrayAdapter<CharSequence> adapter = ArrayAdapter.createFromResource(this, R.array.pref_location_values, android.R.layout.simple_spinner_item);
		...
		spinOffset.setSelection(adapter.getPosition(settings.getString("location", "Default")));
	...
	public class MyOnItemSelectedListener implements OnItemSelectedListener {
		...
		public void onItemSelected(AdapterView<?> parent, View view, int pos, long id) {
			...
			layOffset.setVisibility(terms.equals("Default") ? View.GONE : View.VISIBLE);
		}
	...
	private void fillData() {
		...
		if (count == 0) {
			...
			try {
				ArrayList<String> fortunes = Fortune.makeFortunes(new InputStreamReader(is), 40, true);

				for (int i = 0; i < fortunes.size(); i++) {
					dbHelper.createAchievement(fortunes.get(i));
				}
				Toast.makeText(this, fortunes.size() + " Found", Toast.LENGTH_SHORT).show();
	...
	public Button.OnClickListener mApplyListener = new Button.OnClickListener() {
		...
		public void onClick(View arg0) {
			...
			SharedPreferences settings = // getSharedPreferences("AchievePrefs",
											// MODE_PRIVATE);
			PreferenceManager.getDefaultSharedPreferences(AchievementActivity.this);
			SharedPreferences.Editor editor = settings.edit();
			editor.putString("location", spinOffset.getSelectedItem().toString());
			int offX = 0, offY = 0;
